...
export const ADD_POST = gql`
    mutation newPost($postTitle: String!, $postText: String!, $postAuthor: String!) {
        newPost(postTitle:$postTitle, postText:$postText, postAuthor:$postAuthor) {
            _id
            postTitle
            postText
            postAuthor
...
export const CREATE_CHAT_COMPLETION = gql`
    createChatCompletion($model: String!, $messages: [MessageInput!]!) {
